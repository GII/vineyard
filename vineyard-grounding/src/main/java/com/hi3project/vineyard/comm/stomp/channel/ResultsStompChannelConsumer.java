 ...
 * @version 1
 */
public class ResultsStompChannelConsumer extends AbstractStompChannelConsumer
{

    public ResultsStompChannelConsumer(
    ...
    {
        super(parameterValuesSerializer, connectionURL, name, bsdlRegistry);
    }
