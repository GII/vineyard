 ...
 * @version 1
 */
public class ResultsJMSChannelProducer extends AbstractJMSChannelProducer
{

    public ResultsJMSChannelProducer(
    ...
    protected MessageProducer initializeMessageProducer(String name) throws ServiceGroundingException
    {
        try
        {
            ...
            return this.messageProducer = this.session.createProducer(queue);
